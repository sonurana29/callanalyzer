      ...
      class rr {
        ...
        touch(t10, e10) {
          ...
          this.setHoverChartIndex(), 1 === (t10 = this.normalize(t10)).touches.length ? s10.isInsidePlot(t10.chartX - s10.plotLeft, t10.chartY - s10.plotTop, {
            visiblePlotOnly: true
          }) && !s10.exporting?.openMenu ? (e10 && this.runPointActions(t10), "touchmove" === t10.type && (i10 = !!o10[0] && Math.pow(o10[0].chartX - t10.chartX, 2) + Math.pow(o10[0].chartY - t10.chartY, 2) >= 16), ri(i10, true) && this.pinch(t10)) : e10 && this.reset() : 2 === t10.touches.length && this.pinch(t10);
        }
        touchSelect(t10) {
        ...
        transform(t10) {
          ...
          for (let t11 of e10) {
            ...
            let {
              ...
              min: D2,
              max: B2
            } = az(t11.getExtremes(), O2 || {}), N2 = l2.parse(f2.min), z2 = l2.parse(f2.max), R2 = E2 ?? N2, W2 = I2 ?? z2, H2 = L2 - P2, F2 = t11.categories ? 0 : Math.min(H2, W2 - R2), X2 = R2 - F2 * (aE(N2) ? 0 : f2.minPadding), G2 = W2 + F2 * (aE(z2) ? 0 : f2.maxPadding), j2 = t11.allowZoomOutside || 1 === k2 || "zoom" !== n10 && k2 > 1, Y2 = Math.min(N2 ?? X2, X2, j2 ? D2 : X2), U2 = Math.max(z2 ?? G2, G2, j2 ? B2 : G2);
